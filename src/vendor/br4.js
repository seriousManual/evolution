...
(function (window) {
    ...
    var eventHandler = function (c) {
        ...
        var insertLeaf = function (o, myTree, depth) {
            ...
            if (myTree.hasSubtree()) {
                //checken in welchen teil des subtrees wir inserten m�ssen (evtl in mehrere! )
                ...
                if (myTree.numberChilds() >= 4) {
                    // zu viele data. m�ssen subtree anlegen, vorhandene in den neuen subtree schmei�en
                    ...
                    //es ist gen�gend platz f�r alle da!
                    myTree.data.push(o);
                }
            }
        ...
        var traverseSubtree = function (st) {
            if (st.hasSubtree()) {
                var tmp = null;
                tmp = myCanvas.createO(br4.o.gRectangle, {
                    z: 10000,
                    x: st.subTree.TL.x,
                    y: st.subTree.TL.y,
                    width: st.subTree.TL.width,
                    height: st.subTree.TL.height,
                    lineWidth: 1,
                    lineColor: '#f00'
                });
                ...
                tmp = myCanvas.createO(br4.o.gRectangle, {
                    ...
                    x: st.subTree.TR.x,
                    y: st.subTree.TR.y,
                    width: st.subTree.TR.width,
                    height: st.subTree.TR.height,
                    lineWidth: 1,
                    lineColor: '#f00'
                });
                debugObjects[tmp] = tmp;
                tmp = myCanvas.createO(br4.o.gRectangle, {
                    ...
                    x: st.subTree.BL.x,
                    y: st.subTree.BL.y,
                    width: st.subTree.BL.width,
                    height: st.subTree.BL.height,
                    lineWidth: 1,
                    lineColor: '#f00'
                });
                debugObjects[tmp] = tmp;
                tmp = myCanvas.createO(br4.o.gRectangle, {
                    ...
                    x: st.subTree.BR.x,
                    y: st.subTree.BR.y,
                    width: st.subTree.BR.width,
                    height: st.subTree.BR.height,
                    lineWidth: 1,
                    lineColor: '#f00'
                });
                debugObjects[tmp] = tmp;
                ...
                for (var k in st.data) {
                    ...
                    var tmp = myCanvas.createO(br4.o.gRectangle, {
                        z: 10000,
                        x: x,
                        y: y,
                        width: w,
    ...
    var renderer = function (myCanvas, placeHolderId) {
        ...
        this.startInterval = function () {
            ...
            if (intervalTime > 0) {
                $(this).everyTime(intervalTime, 'redrawing', function () {
                    that.redraw(false);
                });
            }
        };
    ...
    var oObject = function () {
        ...
        this.mouseclick = this.mouseover = this.mouseout = this.mousemove = function () {
            throw 'missing implementation for mouseevent!'
        };
    ...
    var oStencil = function () {
        ...
        this.initChild = function () {
            throw 'missing init child function'
        };
        this.drawChild = function () {
            throw 'missing draw child implementation'
        };
